...
export async function POST(request: Request) {
  ...
  const payloadBody = requestBody({ template: selected.requestTemplateJson, model: runtimeModel, prompt });
  ...
  const imageUrl = readImageUrl(payload, selected.responseUrlPath);
